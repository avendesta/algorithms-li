...
public class Graph {
	Graph spanningTree;
	Boolean isconnected;
	HashMap<Vertex,Vertex> traversedVertices;
	...
	//TO-DO
    List<Vertex> unreachableVertices(Vertex v) {
    	UnreachableVertices uv = new UnreachableVertices(this);
    	return uv.unreachables(v);
    }
